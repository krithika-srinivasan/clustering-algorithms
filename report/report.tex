...
\end{enumerate}
\begin{figure}[H]
\subfloat[cho.txt]{\includegraphics[scale=0.3]{report/images/cluster_dbscan_computed_cho.png}

}\hfill{}\subfloat[iyer.txt]{\includegraphics[scale=0.3]{report/images/cluster_dbscan_computed_iyer.png}
...
\begin{figure}[H]
\subfloat[cho.txt]{\includegraphics[scale=0.3]{report/images/cluster_gmm_computed_cho.png}

}\hfill{}\subfloat[iyer.txt]{\includegraphics[scale=0.3]{report/images/cluster_gmm_computed_iyer.png}
...
\begin{figure}[H]
\subfloat[cho.txt]{\includegraphics[scale=0.3]{report/images/cluster_spectral_cho.png}

}\vfill{}\subfloat[iyer.txt]{\includegraphics[scale=0.3]{report/images/cluster_spectral_iyer.png}
}
...
algorithm and understand the situations for each each of these algorithms would be 
suitable
\end{document}
